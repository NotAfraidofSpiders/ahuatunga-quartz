...
If an item requires an action to activate, that action isn’t a function of the Use an Item action, so a feature such as the [rogue’s Fast Hands](https://roll20.net/compendium/dnd5e/Classes:Rogue?expansion=34047#toc_19) can’t be used to activate the item.
