...
modified: 2026-04-28T20:13:20.834-05:00
published: 2026-04-28T20:13:20.834-05:00
tags:
  - Rules
  - Homebrew
---

The following content is from [rpgbot.net](https://rpgbot.net/dnd5/dungeonmasters/temperature-and-weather-rules/)
...
## Temperature Band Table

| Category        | Temperature                         | Description                                                                                       | Effect                                                                                                                                                                            |
| --------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
\* increase DC by 5 each time the creature rolls the save. Reduce the DC by 5 for every hour the creature spends recovering in comfortable temperatures.
...
- **Light Precipitation:** Light rain, gentle snowfall, or similar conditions.
  ...
  - [[Ability Scores#Advantage and Disadvantage|Disadvantage]] on [[Ability Scores#Wisdom Checks|Wisdom (Perception) checks]] to see at long distances.
- **Heavy Precipitation:** Heavy rain, snow, or similar conditions.
  - Move two steps toward cold temperatures.
  - Everything in the area of precipitation is [[Environment Rules#Lightly Obscured|lightly obscured]]
  - Creatures in the area have [[Ability Scores#Advantage and Disadvantage|disadvantage]] on [[Ability Scores#Wisdom Checks|Wisdom (Perception) checks]] that rely on sight. Heavy rain or hail also imposes Disadvantage on Wisdom (Perception) checks and immediately extinguishes open flames, such as campfires and torches.

## Wind

On a hot day, wind can feel welcome. On a cold day, it makes the cold that much worse.

- **Moderate Wind:**
  - Move one step toward cold temperatures
- **Strong Wind:**
  - Move two steps toward cold temperatures
  - [[Ability Scores#Advantage and Disadvantage|Disadvantage]] on [[Combat Rules#Ranged Attacks|ranged weapon attack rolls]] and [[Ability Scores#Wisdom Checks|Wisdom (Perception) checks]] that rely on hearing
  - Extinguishes most open flames, disperses fog
  - [[Movement Rules#Special Types of Movement|Flying]] by non-magical means is impossible. Most flying creatures must land by the end of their turn or fall.
  - Depending on terrain, may also cause sand, snow, or dust to obscure vision, imposing [[Ability Scores#Advantage and Disadvantage|disadvantage]] on [[Ability Scores#Wisdom Checks|Wisdom (Perception) checks]] to see
...
Clothing is humanoids’ first line of defense against the elements. Wearing warm clothing in the winter and cool clothing in the summer.

For creatures wearing multiple types of clothing (such as cold weather gear over [[Armor Rules#Heavy Armor|heavy armor]]), use whichever type of clothing is the warmest. For example: If a creature is wearing [[Armor Rules#Heavy Armor|heavy armor]] and hot weather clothing, use the modifier for [[Armor Rules#Heavy Armor|heavy armor]].
...
- **[[Armor Rules#Heavy Armor|Heavy Armor]]**: Full plate and similar heavy armor includes layers of chain mail and padded clothing, all of which can insulate the wearer.
...
- **Shade:** Taking frequent breaks to cool off in the shade can make hot temperatures much more manageable. This might mean sitting under a shady tree, or it might mean traveling in a litter with a shade over you.
  - If the vast majority of a given time period is spent in the shade, move one step toward cold temperatures
